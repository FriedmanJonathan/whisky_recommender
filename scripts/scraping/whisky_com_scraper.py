...
def extract_individual_whisky_data(title_div, rating_div):
    ...
    whisky_data = {
        ...
        'whisky_name': title_div.find('span', class_='marke').text.strip() if title_div.find('span', class_='marke') else None,
        'whisky_age': title_div.find('span', class_='alterEtikett').text.strip() if title_div.find('span', class_='alterEtikett') else None,
        'bottling_date': title_div.find('span', class_='abfuelldatum').text.strip() if title_div.find('span', class_='abfuelldatum') else None,
        'whisky_name_suffix': title_div.find('span', class_='namenszusatz').text.strip() if title_div.find('span', class_='namenszusatz') else None,
        'alcohol_pct': title_div.find('span', class_='alkoholgehalt').text.strip() if title_div.find('span', class_='alkoholgehalt') else None,
        'whisky_rating': None,
        'num_ratings': 0,
        'num_reviews': 0
    }
